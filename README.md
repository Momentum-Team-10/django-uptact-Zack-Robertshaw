...
- If I wanted to add a new URL to this project, what two files would I edit?  URLS.PY, 
- If I wanted to add a birthday to each contact, what file would I edit? MODELS.PY AND FORMS.PY
